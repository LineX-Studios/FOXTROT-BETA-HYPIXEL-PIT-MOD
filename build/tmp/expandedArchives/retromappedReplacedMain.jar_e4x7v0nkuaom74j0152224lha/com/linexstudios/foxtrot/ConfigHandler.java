...
public class ConfigHandler {
    private static final File configFile = new File(Minecraft.func_71410_x().field_71412_D, "config/foxtrot_enemies.txt");
    private static final File settingsFile = new File(Minecraft.func_71410_x().field_71412_D, "config/foxtrot_settings.cfg");
